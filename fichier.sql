...
insert into orders values(1001,to_date('15-05-2001','DD-MM-YYYY'),to_date('10-06-2001','DD-MM-YYYY'),102,'43-22-22','CBM Compound','Vizag','AP','530012','744545');

insert into orders values(1002,to_date('15-05-2001','DD-MM-YYYY'),to_date('5-06-2001','DD-MM-YYYY'),101, '12-22-29','Dwarakanagar','Vizag','AP','530016','453343,634333');

insert into orders values(1003,to_date('17-05-2001','DD-MM-YYYY'),to_date('7-06-2001','DD-MM-YYYY'),101, '12-22-29','Dwarakanagar','Vizag','AP','530016','453343,634333');

insert into orders values(1004,to_date('18-05-2001','DD-MM-YYYY'),to_date('17-06-2001','DD-MM-YYYY'),103,'45-45-52','Abid Nagar', 'Vizag','AP','530016','567434');

insert into orders values(1005,to_date('20-05-2001','DD-MM-YYYY'),to_date('3-06-2001','DD-MM-YYYY'),104,'33-34-56','Muralinagar','Vizag','AP','530021','875655,876563,872222');

insert into orders values(1006,to_date('23-05-2001','DD-MM-YYYY'),to_date('11-06-2001','DD-MM-YYYY'),104,'54-22-12','MVP Colony','Vizag','AP','530024',null);
----------------------------------------------------------------------------------------------------------
